...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/weather.recentHistory.$cityName.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1705091645092.6416";
}
function WeatherRecentHistory({
  request
}) {
  _s();
...
_s(WeatherRecentHistory, "5thj+e1edPyRpKif1JmVRC6KArE=", false, function() {
  return [useLoaderData];
});
_c = WeatherRecentHistory;
var _c;
$RefreshReg$(_c, "WeatherRecentHistory");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
export {
  WeatherRecentHistory as default
};
//# sourceMappingURL=/build/routes/weather.recentHistory.$cityName-C7Q3VPHT.js.map
